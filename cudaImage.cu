...
double CudaImage::Download(float *hostmem)
{
  // Obviates the need to call Allocate, provided the input image size remains
  // constant. (cudaMallocPitch is a temporally expensive call)
  h_data = hostmem;
